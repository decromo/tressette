...
gcc common/network.c common/threads.c server.c server/server_network.c common/utils.c common/common.c -lraylib -lGL -lm -lpthread -ldl -lrt     -DPLUG_DEV -g -Wall  "${cmdLineCompileFlags[@]}" -export-dynamic -o ../server; 
EOPART
)
echo $ret)
