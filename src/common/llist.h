...
inline void llist_add(void *list, void *node) {
    llist *ll = list;
    llist_node *n = node;
...
inline void llist_append(void *list, void *node) {
    llist *ll = list;
    llist_node *n = node;
    assert(ll != NULL && n != NULL);
...
inline void llist_pop(void *list) {
    assert(list != NULL);
    llist *ll = list;
...
inline void llist_remove(void *list, void *node) {
...
inline void llist_nuke(void *list, void (fun)(void *node)) {
    llist *ll = list;
    llist_node *n;
...
inline void llist_init(void *list) {
    assert(list != NULL);
